...
Route::group(['middleware' => 'cors'], function () {
	...
	Route::get('form-complaint2','CustomController@coba');
	...
	Route::get('test123','BP\WebController@test123');
	Route::get('/test', 'BP\WebController@test')->name('test');
	...
	Route::get('/careers/application','BP\WebController@career_application')->name('career_application');
...
//Route::post('ielts-simulation','BP\WebController@post_ielts_simulation_school');
	Route::get('/ielts-simulation/{nama_sekolah}','BP\WebController@ielts_simulation_school');
//Route::get('/temp-ielts-simulation/{nama_sekolah}','BP\WebController@ielts_simulation_school');
//Route::post('/temp-ielts-simulation','BP\WebController@temp_post_ielts_simulation_school');
	Route::post('/ielts-simulation-school','BP\WebController@post_ielts_simulation_school');
	Route::get('/document-translation','BP\WebController@document_translate')->name('document_translate');
...
/*Route::post('/fma/registration',function(Request $request){
...
//Route::get('/admin','MerchantController@index')->name('member_admin_login');
...
Route::get('/promo-scan/{kodepromo}','MemberController@promo_qrcode_scan');
...
Route::group(['middleware' => ['merchant-auth']],function(){
	...
	//Route::put('member-les/admin/profile/password', ['as' => 'profile.password', 'uses' => 'ProfileController@password']);
});
...
Route::post('/student/register','Auth\StudentRegisterController@register')->name('student-post-register');
Route::post('/student/register/bank_account_details','Auth\StudentRegisterController@bank_account_details')->name('student-register-bank-account-details');
...
Route::prefix('search-schools')->group(function(){
	Route::group(['middleware' => 'school-auth'],function(){
...
/*Route::resource('options','Admin\Tutor\ModuleController',['names' =>  [
'create' => 'ot-module.create',
'index' => 'ot-module.index',
'store' => 'ot-module.store',
'destroy' => 'ot-module.destroy',
