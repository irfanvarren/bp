          ...
          <form method="post" action="{{route('school-country.update',$country)}}" enctype="multipart/form-data" autocoschool-countrylete="off" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{__('Country Description')}}</label>
                  <div class="col-sm-7">
                     <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="input-description" type="text" placeholder="{{ __('Country Description') }}" aria-required="true">{{ old('description',$country->description) }}</textarea>
