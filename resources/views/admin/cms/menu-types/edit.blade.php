...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <form method="post" action="{{route('cms.menu-types.update',$menu_type)}}" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
          @csrf
          @method('put')
          <div class="card ">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" name="name" value="{{$menu_type->name}}">
                    @if ($errors->has('name'))
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('slug') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" name="slug" value="{{$menu_type->slug}}">
                    @if ($errors->has('slug'))
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('mode_type') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" name="mode_type" value="{{$menu_type->model_type}}">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('label') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" name="label" value="{{$menu_type->label}}">
                    @if ($errors->has('label'))
             ...
             <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('value') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" name="value" value="{{$menu_type->value}}">
                    @if ($errors->has('value'))
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('relationship_settings') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" name="relationship_settings" value="{{$menu_type->relationship_settings}}">
