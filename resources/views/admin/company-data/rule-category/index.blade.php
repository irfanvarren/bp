          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 text-right">
                <a href="{{ route('admin-rule-category.create') }}" class="btn btn-sm btn-primary">{{ __('Add Category') }}</a>
              </div>
            </div>
                <!--
              <div class="row">
                ...
                <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <form method="POST" action="{{route('admin-rule-category.destroy',$data)}}">
                          @csrf
                          @method('delete')
                        <a href="{{route('admin-rule-category.edit',$data)}}" class="btn btn-success btn-link" data-original-title="" title="">
