              ...
              <div class="card-body">
                ...
                @endif
                  ...
                  <div class="col-12 text-right">
                    <a href="{{ route('admin-rule.create') }}" class="btn btn-sm btn-primary">{{ __('Add Rule') }}</a>
                  </div>
                </div>
                <!--
              <div class="row">
                    ...
                    <tbody>
                      @foreach($rules as $data)
                        <tr>
                          ...
                          <td>
                              <form method="POST" action="{{route('admin-rule.destroy',$data)}}">
                          @csrf
                          @method('delete')
                        <a href="{{route('admin-rule.edit',$data)}}" class="btn btn-success btn-link" data-original-title="" title="">
