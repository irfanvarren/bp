...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <form method="post" action="{{route('admin-berdayakan-rule.update',$rule)}}" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
          @csrf
          @method('put')
          <div class="card ">
            <div class="card-header card-header-primary">
              <h4 class="card-title">{{ __('Edit Rule') }}</h4>
              <p class="card-category"></p>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-md-12 text-right">
                  <a href="{{route('admin-berdayakan-rule.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-7">
                  <textarea class="tinymce-editor" id="rule_preview" name="rule_preview">{!!$rule->rule_preview!!}</textarea>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-7">
                     <textarea class="tinymce-editor" id="rule" name="rule">{!! $rule->rule !!}</textarea>
                </div>
              </div>
              
            </div>
            <div class="card-footer ml-auto mr-auto">
              <button type="submit" class="btn btn-primary">{{ __('Edit Rule') }}</button>
