          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 text-right">
                <a href="{{ route('admin-berdayakan-contract.create') }}" class="btn btn-sm btn-primary">{{ __('Add Contract') }}</a>
              </div>
            </div>
                @csrf
                ...
                <td>
                  <form method="POST" action="{{route('admin-berdayakan-contract.destroy',$data)}}">
                    @csrf
                    @method('delete')
                    <a href="{{route('admin-berdayakan-contract.edit',$data)}}" class="btn btn-success btn-link" data-original-title="" title="">
