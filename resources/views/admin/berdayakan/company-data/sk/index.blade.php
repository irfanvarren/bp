          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 text-right">
                <a href="{{ route('admin-berdayakan-sk.create') }}" class="btn btn-sm btn-primary">{{ __('Add SK') }}</a>
              </div>
            </div>
                <!--
              <div class="row">
                ...
                <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <td>
                      <form method="POST" action="{{route('admin-berdayakan-sk.destroy',['sk' => urlencode(urlencode($data->no))])}}">
                        @csrf
                        @method('delete')
                        <a href="{{route('admin-berdayakan-sk.edit',['sk' => urlencode(urlencode($data->no))] )}}" class="btn btn-success btn-link" data-original-title="" title="">
