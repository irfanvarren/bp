...
<div class="col-md-12 content-wrapper online-test-wrapper" id="app">
	...
	<div class="row justify-content-center show-type introduction" @if($show_type != 'introduction') @if($structure->question_type == 'instruction')  @else style="display:none" @endif @endif id="introduction-instruction-wrapper">
				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-md-12 text-center" @if($structure->audio != "") style="display:none" @endif id="instruction-audio-wrapper">
							...
							<audio id="instruction-audio" class="instruction-audio" controls="false" style="display:none;">
					...
					<div class="card-body" style="min-height:300px;">
						<div class="form-group row">
							...
							<div class="col-md-12 text-center">
								...
								<audio id="introduction-audio" class="introduction-audio" controls="false" style="display:none;">
									<source src=" {{asset($structure->audio)}}" type="audio/ogg">
										Your browser does not support the audio element.
									</audio> 
								</div>
											...
											<div class="col-md-12   @if($structure->option_type != 'record-audio' || $test_section['section_type_id'] == 1) {{'hide'}} @endif" style="min-height: 300px;padding:80px 15px;" id="record-audio-wrapper">
												<div class="row justify-content-center">
													<div style="display: block;margin:auto;text-align:center;">
														...
														<div>
															<img @if($structure->image == "") class="hide" @endif src="{{asset($structure->image)}}" id="record-audio-image" style="max-width:50%; ">
														</div>
														<div id="speaking-audio-output">
															...
															<audio id="speaking-audio" class="speaking-audio" controls="false" style="display:none;">
																<source src=" {{asset($structure->audio)}}" type="audio/ogg">
																	Your browser does not support the audio element.
																</audio> 
																<br>
																<div id="recorder-button">
																	<div id="recorder-button-div">Record</div>
																</div>
																<div style="margin:15px;"> 
																	<audio id="recorder-audio" @if($structure->answers != "") {{'controls'}}@endif>
																		@if($structure->answers != "")
																		<source src=" {{asset($structure->answers)}}" type="audio/ogg">
																			Your browser does not support the audio element.
																			@endif
																		</audio>
																	</div>
		...
		<div id="test"></div>
		@push('more-script')
		<script src="{{asset('js/web_audio_recorder_js/WebAudioRecorder.js')}}"></script>
		<script>
	...
	if(data.trim() == "finish"){
		...
		if(section.type == "introduction" || structure.question_type == "instruction"){
			...
			if(structure.question_type == "instruction"){
				...
				$("#instruction-audio").attr("src",url+structure.image);
			}else{
