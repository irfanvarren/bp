          ...
          <div class="card-body" style="padding:30px 15px;">
            ...
            <div class="col-md-3" style="max-height:600px;overflow: auto;">
              <ul class="nav nav-pills nav-fill">
                <li class="nav-item">
                  <a class="nav-link active tab" href="#menu1" data-toggle="tab">Australia</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" href="#menu2" data-toggle="tab">Kanada</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" href="#menu3" data-toggle="tab">Singapura</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu4">Selandia Baru</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu5">Malaysia</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu7">Swiss</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu8">Korea Selatan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu9">Inggris</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu10">Amerika</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu11">Irlandia</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu12">Indonesia</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu13">Perancis</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu14">China</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu15">Swedia</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu16">Belanda</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu17">Spanyol</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu18">Jepang</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link tab" data-toggle="tab" href="#menu19">Surat Pernyataan Testimoni</a>
                </li>
            ...
            <div class="col-md-9 tab-content" id="myContent">
              <div id="menu1" class="tab-pane fade show active">
               ...
               <ol>
                 ...
                 <li>
                  Saya menyetujui biaya-biaya yang telah diterangkan oleh pihak Best Partner                     
                </li>
                ...
                <li>
                Saya menyetujui apabila terdapat kekurangan pembayaran biaya apapun yang termasuk dalam proses aplikasi visa saya, maka saya tidak dapat/tidak berhak/tidak memiliki wewenang untuk meminta dokumen aplikasi visa saya.</li>
                <li>Jika terjadi penolakan visa, saya menerima pengembalian uang sesuai harga kurs berjalan dan berhak menerima refund setelah 28 hari kerja. Bila ada permintaan refund dalam bentuk AUD harus diinfokan terlebih dahulu pada pihak Best Partner. Jika tidak ada permintaan maka Pihak Best Partner akan mengembalikan dalam bentuk Rupiah. </li>
                <li>

                Jika saya membatalkan proses aplikasi sekolah sebelum pengajuan visa, maka saya setuju untuk dikenakan potongan biaya administrasi sebesar AU$200 dan mengikuti poin nomor 4 sesuai dengan biaya yang dibebankan oleh sekolah.</li>
                <li>
