                ...
                <div class="modal-content">
                    ...
                    <form method="post" action="" v-on:submit.prevent="addMenuItem(item)">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="text" name="url" class="form-control input-field" id="add_menu_item_url" v-on:keyup="checkParamaterKeyup" v-model="item.url">
                                <label for="add_menu_item_url"   class="cs-label">URL test2</label>
                            </div>
                            <div class="form-group">
