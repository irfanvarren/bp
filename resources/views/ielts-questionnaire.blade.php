...
<div class="col-md-12 content-wrapper">
  ...
  <div class="row justify-content-center">
    ...
    <form class="" action="{{ url('/ielts-questionnaire')}}" method="post">
      {{ csrf_field() }}
  <div class="col-md-12">
<div class="row">
...
<div class="row form-group">
  <label class="col-form-label col-md-12">Bagaimana Ruangan Test IELTS BEST PARTNER EDUCATION?</label>
  <input type="hidden" name="q1" value="Bagaimana Ruangan Test IELTS BEST PARTNER EDUCATION?">
  <div class="col-md-12">
