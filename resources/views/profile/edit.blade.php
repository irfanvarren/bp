          ...
          <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                @role('Staff|Admin|Super Admin|Director')
                                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Employee Id') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('employee_id') ? ' has-danger' : '' }}">
                      <input type="text" name="employee_id" id="employee_id" class="form-control" value="{{auth()->user()->employee_id != '' ? auth()->user()->employee_id : ''}}">
