...
<p>Hi {{$email->NAMA}},</p>
<p>Terima kasih telah melakukan pendaftaran Simulasi Test PTE Academic di BEST PARTNER EDUCATION. Pendaftaran anda akan kami proses setelah anda melakukan pembayaran dengan rincian pembayaran dibawah ini: </p>
<table class="price-table">
<tr style="border-top:2px solid black;border-bottom:2px solid black;">
  <th>No.</th> <th>Jumlah</th> <th>Deskripsi Barang</th> <th></th><th>Harga.</th>
</tr>
<tr>
  <td>1.</td><td>1 x</td> <td>Biaya Simulasi Test PTE Academic</td> <td>Rp.</td><td>{{number_format($email->HARGA_PAKET,2,',','.')}}</td>
</tr>
...
<p>Setelah berhasil melakukan pembayaran, silahkan untuk mengkonfirmasi kepada pihak Best Partner Education dengan cara mengirimkan bukti pembayaran ke divisi keuangan Best Partner Education di alamat email finance@bestpartnereducation.com.
<br />
