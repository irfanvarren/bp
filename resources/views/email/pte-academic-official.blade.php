...
<h3 style="margin-top</td><td>200px;">Data Pendaftaran PTE Academic Official {{$email->fast_regis == "on" ? "(Registration less than 48 hours)" : ""}}</h3>

<table class="table table-bordered">
    <tr>
        <th colspan="2">Data Pendaftaran PTE Academic Official</th>
    </tr>
    <tr>
        <td>Nama</td>
