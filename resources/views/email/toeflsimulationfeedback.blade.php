  ...
  <body>
    <div class="email-wrapper">
      ...
      <div class="wrapper" style="">
        <p> Hi {{$email->NAMA}}, </p>
        <p> Terima kasih telah mendaftar Simulasi TOEFL ITP di BEST PARTNER EDUCATION. Untuk tanggal dan jam pelaksanaan simulasi akan kami email atau hubungi melalui telepon selular. Pastikan data yang anda input BENAR. Sebelum simulasi dimulai diharapakan bisa melakukan pembayaran ke rekening kami atas nama CV. BEST PARTNER dengan informasi lengkap rekening tujuan transfer sebagai berikut:  </p>
