     ...
     <form class="" action="{{url('fma/registration')}}" method="post" enctype="multipart/form-data">
      ...
      <div class="form-tab">
        ...
        <p>
          ...
          <p>
          <strong>Syarat dan Ketentuan FMA Program</strong>
          <div>Mohon untuk membaca dan memahami Syarat dan Ketentuan serta Privacy Policy/Kebijakan Privasi Best Partner sebelum menyetujui syarat dan ketentuan berikut ini. Mohon untuk membaca Persetujuan ini dengan seksama sebelum Anda berpartisipasi dalam FMA Program Best Partner. Dengan berpartisipasi dalam FMA Program Best Partner, Anda mengkonfirmasi bahwa Anda menyetujui Persetujuan ini dan bersedia untuk mematuhinya. Apabila Anda tidak setuju dengan syarat – syarat Persetujuan ini, maka Anda tidak diperkenankan untuk berpartisipasi dalam FMA Program Best Partner</div><br>
          <ol>
            <li>
              Promotor
              <div>Promotor dari FMA Program adalah CV. Best Partner yang berdiri di Indonesia yang memiliki kantor teregistrasi di Jalan Dr. Prof Hamka No.29-30, </div>
            </li>
            <li>Kelayakan
              <div>Anda hanya dapat berpartisipasi apabila Anda adalah FMA Best Partner yang sudah teregistrasi. Program ini terbuka untuk umum tanpa terbatas usia. 
</div>
            </li>
            <li>Durasi
              <div>Anda akan memiliki kesempatan untuk mendapatkan hadiah sejak pertama kali Anda mendaftar untuk akun FMA. Tidak ada limit dalam jumlah teman yang dapat Anda rekomendasikan maupun jumlah Hadiah yang dapat Anda miliki! Bonus dari kami hanya dapat dimiliki berdasarkan keberhasilan teman – teman Anda melakukan Transaksi yang Memenuhi Syarat.
</div>
            </li>
          </ol>
        </p>
      ...
      <div class="form-tab">
       ...
       <div>Setelah Anda menyetujui peraturan – peraturan yang tertera di Persetujuan ini, Best Partner akan memberi Anda “Bonus” yang ditujukan kepada akun bank personal Anda. Bonus dihitung per-client. Jumlah bonus yang akan Anda dapatkan adalah sejumlah berikut:</div> <br>
       <div class="mb-3">
         <table >
           
           <tr>
             <td>Murid ke 1-10 = 15%</td>
           </tr>
           <tr>
             <td>Murid ke 11-20 = 20%</td>
           </tr>
           <tr>
             <td>Murid ke 21-30 = 25%</td>
           </tr>
           <tr>
             <td>Murid ke 31-40 = 30%</td>
           </tr>
         </table>
       </div>
       <div>
         Simulasi Bonus: <br>
         Harga kelas Rp2,500,000 <br>
        Dengan status murid pertama, maka akan mendapatkan bonus sebesar Rp 375,000 dan seterusnya.
       </div>
       </p>

       <div><strong>Transaksi yang Memenuhi Syarat</strong></div>
       <div>
        Transaksi yang Memenuhi Syarat adalah transaksi dengan produk kelas minimal kelas 10 jam. Mohon dipahami bahwa ketentuan dalam syarat dan Ketentuan Referral Program ini dapat berubah sewaktu-waktu. Transaksi yang Memenuhi Syarat harus diselesaikan melalui  pembayaran ke <strong>rekening 1061294712 Bank Syariah Indonesia (BRIS) a.n Yayasan Berdayakan Anak Bangsa</strong>. Khusus untuk produk IELTS Test Official dan PTE Test Official, dikirimkan ke rekening BCA 0299008144 A/n BEST PARTNER CV. Client diharuskan untuk menyelesaikan transaksi terlebih dahulu sebelum FMA berhak mendapatkan bonus yang akan langsung ditransfer ke rekening personal FMA.
       </div>
      </p>
    </div>
    <div class="form-tab">  
