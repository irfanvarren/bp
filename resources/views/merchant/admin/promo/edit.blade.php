  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        <form method="post" action="{{route('promo.update',$promo)}}" autocopromolete="off" class="form-horizontal" enctype="multipart/form-data">
          @csrf
          @method('put')
            ...
            <div class="card-body ">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  ...
                  $potongan = $promo->potongan_harga;
                }else{
                $potongan = $promo->potongan_persen;
              }
                  @endphp
                  <div class="form-group{{ $errors->has('potongan_harga') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('potongan_harga') ? ' is-invalid' : '' }}" name="potongan" id="input-potongan_harga" type="number" placeholder="{{ __('Potongan Harga') }}" value="{{ old('potongan_harga',$potongan) }}" required />
                    @if ($errors->has('harga'))
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('keterangan') ? ' has-danger' : '' }}">
                    <textarea class="form-control{{ $errors->has('keterangan') ? ' is-invalid' : '' }}" rows="3" name="keterangan" id="input-keterangan"  value="{{ old('keterangan',$promo->keterangan) }}" required>{{$promo->keterangan}}</textarea>
                    @if ($errors->has('harga'))
