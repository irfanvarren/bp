...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <form method="post" action="{{route('mp.store')}}" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
          @csrf
          @method('post')
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group{{ $errors->has('kategori_produk') ? ' has-danger' : '' }}">
                        <select name="kategori_produk selectize" class="form-control" required id="kategori_produk">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('harga') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('harga') ? ' is-invalid' : '' }}" name="harga" id="input-harga" type="text" placeholder="{{ __('Harga') }}" value="{{ old('harga') }}" required />
                    @if ($errors->has('harga'))
