          ...
          <form method="post" action="{{route('promo.store')}}" autocopromolete="off" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Jumlah Promo') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('jlh') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('jlh') ? ' is-invalid' : '' }}" name="jlh" id="input-jlh" type="number" placeholder="{{ __('Jumlah Promo') }}" value="{{ old('jlh') }}" required />
                      @if ($errors->has('jlh'))
