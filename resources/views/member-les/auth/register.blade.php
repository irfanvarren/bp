...
<div class="container" style="height: auto;">
  ...
  <div class="row align-items-center">
    ...
    <div class="col-lg-6 col-md-8 col-sm-10 ml-auto mr-auto">
      ...
      <form class="form" method="POST" action="{{route('member-admin-post-register')}}">
        @csrf
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="{{ __('Nama Usaha...') }}" value="{{ old('name') }}" required>
              </div>
              @if ($errors->has('name'))
