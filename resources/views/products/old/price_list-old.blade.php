  ...
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="row">
       <div class="col-md-12">
        <div class="row">
          <ul class="nav nav-tabs mytab col-md-12" id="myTab" role="tablist">
   ...
   @if(count($pricelists[0]->packets[0]->details))
        <table class="tb-pricelist table table-bordered" style="margin:30px 0 !important;"> 
          ...
          <thead>
            <tr>
            <th class="text-left">{{$pricelists[0]->packets[0]->NAMA}}</th><th>Duration</th><th>Category</th><th>Price</th>
          </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td>{{round($detail->where('REF_LEVEL',$key)->groupBy('REF_KATEGORI')->first()[0]->JUMLAH_JAM)}} Jam</td>
            ...
            <tr>
              <td>{{round($kategori->first()->JUMLAH_JAM)}} Jam</td>
