...
<body>
	<div style="width:100%">
		<div class="text-center" style="position: relative;border-bottom:thick double;margin-bottom:10px;">
			<div style="position: absolute;width: 60px;display: inline-block;height: 100px;top:15px;left:15px;vertical-align: middle;">
				<img src="<?php echo asset('/img/logo3.png')?>" style="height: 70px;line-height: 100px;margin-top:15px;">
			</div>
			<div style="padding:10px;padding-left: 30px;">
				<h1 class="m-0"><strong>BEST PARTNER EDUCATION</strong></h1>
				<div>Jl. Prof. Dr. Hamka No. 29-30 Pontianak, Kalimantan Barat 78115, Indonesia</div>
		...
		<div>
			...
			<table class="table table-bordered">
				<tr>
					<th>Nama Murid</th><td><?php echo $registration_data ? e($registration_data->NAMA) : ""?></td><th>No. KTP</th><td><?php echo $registration_data ?  e($registration_data->REF_KTP) : ""?></td>
				</tr>
				<tr>
					<th>Tanggal Lahir</th><td><?php echo $registration_data ? e(date("d/m/Y",strtotime($registration_data->TGL_LAHIR))) : ""?></td><th>N/A</th><td>-</td>
				</tr>
				<tr>
					<th>Jenis Kelamin</th><td><?php echo $registration_data ? e($registration_data->JK) : ""?></td><th>Email</th><td><?php echo $registration_data ? e($registration_data->EMAIL) : "" ?></td>
				</tr>
				<tr>
					<th>No. Handphone</th><td><?php echo $registration_data ? e($registration_data->KONTAK) : ""?></td><th>Marketing</th><td>-</td>
				</tr>
				<tr>
					<th rowspan="2">Alamat</th><td rowspan="2"><?php echo $registration_data ? e($registration_data->ALAMAT) : ""?></td><th>Marketing Email</th><td>-</td>
				</tr>
				<tr>
			...
			<table class="table table-bordered">
				...
				if(count($cart_items)){
					foreach ($cart_items as $item) {
						?>
						<tr>
							<td><?php echo $item->NAMA_PAKET;?> <?php echo $item->REF_LEVEL ?></td><th><?php echo count($item->intakes) ? $item->intakes : "-" ?></th><th><?php echo count($item->intakes) ? $item->intakes : "-"?></th><th><?php echo e(number_format($item->JUMLAH_JAM),2,',','.') ?> Jam</th><th>Rp.<?php echo number_format($item->HARGA_PAKET,2,',','.');?></th>
						</tr>
						<?php
					}
				}
