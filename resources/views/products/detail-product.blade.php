...
<div class="col-md-12">
	<div class="container-fluid row p-5 martop8">
		<div class="col-sm-7 p-5">
			<h1 class="w3-jumbo"><b>{{$course->NAMA}}</b></h1>
			<p class="w3-xlarge">
			{{$course->description != "" ? $course->description : "No Description"}}
			</p>
		</div>
		<div class="col-sm-5">
			<img src="{{asset('/img/28.png')}}">
		</div>
	</div>
	<div class="container row" style="margin:auto;">
		<div class="col-sm-5">
			...
			<div class="panel">
				<p onclick="bukapanel(1)">menu 1</p>
				<p onclick="bukapanel(2)">menu 2</p>
				<p onclick="bukapanel(3)">menu 3</p>
				<p onclick="bukapanel(4)">menu 4</p>
				<p onclick="bukapanel(5)">menu 5</p>
			</div>
		...
		<input type="text" hidden value="1" id="lama">
	</div>
</div>
...
<script type="text/javascript">
			...
			function bukapanel(id){
				var idlama = document.getElementById('lama').value;
				document.getElementById(idlama).style.display="none";
				document.getElementById('lama').value = id;
