...
@endif
<div class="col-md-12 ielts_form">
  <div class="row">
  ...
  <div class="row justify-content-center">
    ...
    <div class="row">
      <div class="col-md-12 card ielts-official-form" >
        <div class="card-body">
          <form name="myForm" id="myForm" action="/products/ielts-test/official" method="post" enctype="multipart/form-data" autocomplete="on">
            @csrf
            <div class="tab-wrapper office-wrapper show">
              <div class="row form-group">
                <div class="col-md-12 pb-2">
                  <strong>Test Module</strong> / Modul Tes
                </div>
                <div class="col-md-12">
                  <div class="row">
                    <div class="form-check-inline">
                      <input type="radio" class="form-check-input" name="TEST_MODULE" id="ac" value="AC" {{ session('ielts_form.test_module')=="AC" ? 'checked' : '' }} data-parsley-required="true" required> <label class="form-check-label" for="">Academic</label>
                    </div>
                    <div class="form-check-inline">
                      <input type="radio" name="TEST_MODULE" id="gt" value="GT" class="form-check-input" {{ session('ielts_form.test_module')=="GT" ? 'checked' : '' }} data-parsley-required="true" required>
              ...
              <div class="row">
                ...
                <div class="col-md-12 pt-2 mt-2">
                  ...
                  <div class="form-check-inline m-0">
                   <input type="checkbox" name="agree" id="agree" class="form-check-input" data-parsley-required="true" required value=""> <label class="form-check-label" for=""> Setuju dengan <a href="{{url('/products/ielts-test/term-and-condition')}}" target="blank">Syarat & Ketentuan</a>
                   </div>
                 </div>
               </div>
             </div>
             ...
             <div class="tab-wrapper office-wrapper">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <div class="row">
                    <p class="col-md-12">Alasan Mengambil Tes IELTS</p>

                  </div>
                  <div class="row">
                    <p class="col-md-12">
                      <select class="form-control" id="alasan_ielts" name="ALASAN" required>
                        <option value="">- Alasan Mengambil IELTS -</option>
...
<script type="text/javascript">
  var today = new Date();
  var availableDates = {!!json_encode($tgl_ielts)!!};
