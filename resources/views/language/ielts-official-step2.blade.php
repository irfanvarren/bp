...
@section('content')
  <div class="col-md-12 content-wrapper ielts_form" >
<form action="/products/ielts-test/official/submit" method="post" enctype="multipart/form-data">
@csrf
    <div class="col-md-12">
      <div class="row">
        <div class="col-md-6">
      ...
      <div class="row">
        <div class="col-md-6">
            ...
            <div class="row">
              <p class="col-md-12">
                <select class="form-control" id="alasan_ielts" name="alasan_ielts" required>
      ...
      <div class="row">
        <div class="col-md-12">
    <a href="{{url('products/ielts-test/official/')}}" class="btn btn-secondary">Back</a>
    <input type="submit" name="" id="submit" value="Submit" class="btn btn-primary" style="float:right;" disabled>
        </div>
