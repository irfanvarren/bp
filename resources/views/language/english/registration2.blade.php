              ...
              <div class="row form-group">
                <div class="col-md-6">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <input type="text" name="sekolah" placeholder="Nama Universitas / Sekolah" class="form-control" value="">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                      ...
                      <select class="form-control" id="course" name="id_course">
                        ...
                        @foreach($paket_bimbel as $data_paket_bimbel)
                          <option value="{{$data_paket_bimbel->KD}}">{{$data_paket_bimbel->NAMA}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="col-md-12">
                      <select class="form-control" name="id_kelompok_kelas" required>
                        ...
                        @foreach($kategori as $data_kategori)
                          <option value="{{$data_kategori->KD}}">{{$data_kategori->NAMA}}</option>
                        @endforeach
                      </select>
                    </div>
...
<script type="text/javascript">
  var kode_pricelist = '{{$kode_pricelist}}';
  var kode_bahasa = '{{$kode_bahasa}}';
...
$("document").ready(function(){
 ...
 $.ajax({
     ...
     method: 'POST',
     data: {course_id:course_id, _token:token,kode_pricelist:kode_pricelist,kode_bahasa:kode_bahasa},
