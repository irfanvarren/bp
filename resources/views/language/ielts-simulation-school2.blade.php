...
<form action="{{url('/ielts-simulation-school')}}" method="post">
  ...
  <div class="col-md-12">
    ...
    <div class="col-md-6">
      <div class="row">
      <p class="col-md-4">
<input type="text" name="tgl_lahir" class="form-control" placeholder="Tanggal (dd)" pattern="[0-9]{2}" required value="">Tanggal Lahir
</p>
<p class="col-md-4">
...
<p class="col-md-4">
  ...
  <div class="col-md-12">
    ...
    <p class="col-md-6 form-check-inline">
      <div class="row">

    <div class="col-md-3">Jenis Kelamin</div>
    <div class="col-md-9">
    <input type="radio" name="jk" value="Laki - laki" required> Laki - laki <input type="radio" name="jk" value="Perempuan" required> Perempuan
  </div>
