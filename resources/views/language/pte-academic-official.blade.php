  ...
  <div class="row justify-content-center">
    ...
    <div class="row">     
     <div class="col-md-12 card ielts-official-form" >
      <div class="card-body">
        <form name="myForm" id="myForm" action="/products/pte-academic/official" enctype="multipart/form-data" method="post">
          @csrf
          ...
          <div class="form-group row">
            <div class="col-md-12">
              <div>
               <input type="checkbox" name="fast_regis" id="fast_regis"> <label class="form-check-label"><strong>Registration less than 48 hours.  {{$harga_fast_regis != "" ? 'Price : + Rp.'.number_format($harga_fast_regis - $harga_pte,2,',','.') : ''}}</strong></label>
             </div>
             <div>
              <input type="checkbox" name="agree" id="agree"  value="">  <label class="form-check-label" for=""> Setuju dengan <a href="{{url('/products/pte-academic/term-and-condition')}}" target="blank">Syarat & Ketentuan</a> </label>
             </div> 
           </div>
         </div>
       </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-12 " style="padding-top:8px;">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <div class="row">
                    <p class="col-md-12">Alasan Mengambil Tes PTE</p>

                  </div>
                  <div class="row">
                    <p class="col-md-12">
                      <select class="form-control" id="alasan_ielts" name="ALASAN" required>
                        <option value="">- Alasan Mengambil PTE -</option>
...
<script type="text/javascript">
  var today = new Date();
  var availableDates = {!!json_encode($tgl_pte)!!};
...
var max_date = new Date(next_year,12,31);
