...
<div class="col-md-12">
  ...
  <div class="row">
    ...
    <div class="my-gallery col-md-12"  style="margin-bottom:15px; overflow-x:auto;max-height: 150px;" itemscope itemtype="http://schema.org/ImageGallery" itemscope itemtype="http://schema.org/ImageGallery">
      ...
      @php
      if(file_exists(asset('img/schools/').'/'.$value->school_id.'/'.rawurlencode($value->image))) {
            ...
            <div class="col-md-11" style="font-size:13px;">
              ...
              <div class="mb-2">
                 Application Fee : 
                    ...
                    <!--<br> 
                - -->{{$school->curr_symbol}} {{$program->enrollment_fee}} {{$school->curr_code}} 
                @else
                -
                @endif
              </div>
              <div>
                Material Fee : 
                   ...
                   <!--<br> 
                - -->{{$school->curr_symbol}} {{$program->material_fee}} {{$school->curr_code}} 
                @else
                -
                @endif
              </div>
