...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{route('school.store')}}" enctype="multipart/form-data" autocoschoollete="off" class="form-horizontal">
            @csrf
            @method('post')
            <div class="card ">   
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('School Name') }}" value="{{ old('name') }}"  aria-required="true"/>
                      @if ($errors->has('name'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="abbreviation" id="input-abbreviation" type="text" placeholder="{{ __('School Abbreviation') }}" value="{{ old('abbreviation') }}"  aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                        <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                          <textarea name="description" class="form-control" id="description" rows="4" id="description"></textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('Email') }}" value="{{ old('email') }}" aria-required="true"/>
                          @if ($errors->has('email'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                        <div class="form-group{{ $errors->has('phone_number') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('phone_number') ? ' is-invalid' : '' }}" name="phone_number" id="input-phone_number" type="text" placeholder="{{ __('Phone Number') }}" value="{{ old('phone_number') }}" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                        <div class="form-group{{ $errors->has('website') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('website') ? ' is-invalid' : '' }}" name="website" id="input-website" type="url" placeholder="{{ __('Website') }}" value="{{ old('website') }}" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                        <div class="form-group{{ $errors->has('working_days') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('working_days') ? ' is-invalid' : '' }}" name="working_days" id="input-working_days" type="text" placeholder="{{ __('Working Days') }}" value="{{ old('working_days') }}" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                        <div class="form-group{{ $errors->has('postal_code') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('postal_code') ? ' is-invalid' : '' }}" name="postal_code" id="input-postal_code" type="text" placeholder="{{ __('Postal Code') }}" value="{{ old('postal_code') }}" aria-required="true"/>
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('region_id') ? ' has-danger' : '' }}">
                      <div class="dropdown bootstrap-select col-sm-12 pl-0 pr-0">
                        ...
                        <select id="city_id" class="selectize" name="city_id" required style="width:100%;">

<!--                        <select class="selectpicker col-sm-12 pl-0 pr-0 " data-style="select-with-transition" id="region_id" name="region_id">-->
                          <option value="">- Select City -</option>

                          @foreach($cities as $key => $value)
                          <option value="{{$value->id}}"> {{$value->name.', '.$value->region_name.', '.$value->country_name}}</option>
                          @endforeach
                        </select>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('enrollment_fee') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('enrollment_fee') ? ' is-invalid' : '' }}" name="enrollment_fee" id="enrollment_fee-input" type="text" placeholder="{{ __('Enrollment Fee') }}" value="{{ old('enrollment_fee') }}"  aria-required="true"/>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                        <div class="form-group{{ $errors->has('intake') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('intake') ? ' is-invalid' : '' }}" name="intake" id="input-intake" type="date" placeholder="{{ __('Intake') }}" value="{{ old('intake') }}" aria-required="true"/>
