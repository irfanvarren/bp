		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>
						Signature: <img src="{{asset($personal_information->signature)}}">
						<div>{{$personal_information->signature != "" ? "Surat pernyataan telah ditandatangani oleh murid" : ""}}</div>
					</p>
				</td>
				<td>
