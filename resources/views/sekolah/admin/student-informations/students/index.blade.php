                    ...
                    <ul class="nav nav-tabs" data-tabs="tabs">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#personal-informations" data-toggle="tab" onclick="open_personal_informations()" id="open-personal-informations">
                          <i class="material-icons">person</i> Personal Informations
          ...
          <table class="table">
            <tbody>
              ...
              <tr>
                <td>Programs</td>
                <td>
                 <select name="cd_program_id" id="cd_program_id" class="form-control selectize">
              ...
              <tr>
               ...
               <td>
                 <input type="text" name="cd_application_fee" id="cd_application_fee" class="form-control">
               </td>
             </tr>
             <tr>
              <td>Material Fee</td>
              <td>   
                <input type="text" name="cd_material_fee" id="cd_material_fee" class="form-control">
              </td>
            </tr>
            <tr>
              <td>CoE Fee</td>
              <td><input type="text" name="cd_coe_fee" id="cd_coe_fee" class="form-control"></td>
            </tr>
            <tr>
              <td>Start Date</td>
