                  ...
                  <div class="col-sm-7">
                    ...
                    <div class="row form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                     <div class="dropdown bootstrap-select col-sm-12 pl-0 pr-0">
                      ...
                      <select id="from_school" class="selectize" name="from_school" required style="width:100%;">
                ...
                <div class="col-sm-7">
                 <div class="row form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                   <div class="dropdown bootstrap-select col-sm-12 pl-0 pr-0">
                    ...
                    <select id="from_program" class="selectize" name="from_program" required disabled style="width:100%;">
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
             <div class="row form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
               <div class="dropdown bootstrap-select col-sm-12 pl-0 pr-0">
                ...
                <select id="to_program" class="selectize" name="to_program" disabled required style="width:100%;">
                  <option value="">- Select Program -</option>
                  @foreach($schools as $school)
                  <option value="{{$school->id}}">{{$school->name}} ({{$school->abbreviation}}), {{$school->address}}, {{$school->city_name}}, {{$school->region_name}}, {{$school->country_name}}</option>
                  @endforeach
           ...
           <div class="col-sm-3">
            <div class="row form-group">
              <div>
              <input type="checkbox" name="all_to_programs" id="all_to_programs" class="form-check-input" checked=""> <label class="form-check-label">All Programs</label>
              </div>
              </div>
            </div>
        </div>
