...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{route('school-course.store')}}" enctype="multipart/form-data" autocoschool-courselete="off" class="form-horizontal">
            @csrf
            @method('post')
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Course Name') }}" value="{{ old('name') }}"  aria-required="true"/>
                      @if ($errors->has('name'))
