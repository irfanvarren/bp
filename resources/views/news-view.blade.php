	...
	<div class="row">
		<div class="col-md-8" style="border-right:1px solid #dedede;padding:30px 15px;">
			<div class="row">
				...
				<div class="col-md-12 news-body" style="margin-top:15px;padding:30px;text-align: justify;overflow-x:auto;">
