      ...
      <div class="card card-login card-hidden mb-3">
        ...
        <div class="card-body" style="padding:0 30px;">
          ...
          <form class="form-horizontal" method="POST" name="myform" action="{{route('student-register')}}" enctype="multipart/form-data">
            ...
            <div class="row input-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
              <label class="col-md-12 col-form-label">Passwords</label>
              <div class="col-md-6">
          ...
          <div class="row input-group">
            ...
            <div class="col-md-12">
              ...
              <select class="selectize form-control" name="visa_country" id="visa_country">
        ...
        <div class="row card-footer">
         <div class="col-md-12">
          <div style="float:right;">
            ...
            <button type="button" class="btn btn-primary" id="btn-submit" onclick="submit_form(event)" disabled>{{ __('Create account') }}</button>
          </div>
        </div>
