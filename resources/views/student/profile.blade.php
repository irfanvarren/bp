...
<style type="text/css">
	...
	.radio-hide:checked + .label-text span {
		padding-bottom: 5px;
		border-bottom:2px solid #0c68a6;
	}
	...
	#sixteen:checked ~ .progress > .progress-bar{
		width: 14%;
		background-color: rgb(48, 174, 30);
	}

	#thirtythree:checked ~ .progress > .progress-bar{
		width: 29.5%;
		background-color: rgb(48, 174, 30);
	}
	...
	#sixtysix:checked ~ .progress > .progress-bar{
		width: 61%;
		background-color: rgb(48, 174, 30);
	}
	#eightythree:checked ~ .progress > .progress-bar{
		width: 80%;
		background-color: rgb(48, 174, 30);
	}
...
<div class="col-md-12" style="padding:30px 45px;">
	<div class="row">
		<div class="col-md-12 mb-3">
			<h3 style="display: inline;">Student Application</h3> <a style="float:right;" href="{{route('student-register')}}" class="btn btn-primary">Register</a>
		</div>
	</div>
...
@csrf
<div class="col-md-12" id="detail-profile-output" style="padding:30px 45px;">
