...
<div class="col-md-12">
	<div class="row">
		<div class="col-md-12 portfolio-background"  style="background:url('{{asset('img/portfolio/background2.png')}}');background-size:cover;background-position: center;">
		</div>
		...
		<div class="col-md-12 portfolio-wrapper">
			<div class="row photo-container" >
				...
				<div class="profile">
					...
					<div>{{ucwords(strtolower($karyawan->REF_PERUSAHAAN))}}</div>
				</div>
			</div>
