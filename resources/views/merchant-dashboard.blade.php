      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6">
            ...
            <div class="card-header card-header-warning card-header-icon">
              ...
              <p class="card-category">Jumlah Poin</p>
              <h3 class="card-title">Rp.{{number_format($point_merchant,0,",",".")}}</h3>
            </div>
            <div class="card-footer">
              <div class="stats">
                <i class="material-icons">payments</i> Poin Merchant
              </div>
            </div>
          </div>
          <div class="card card-stats">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$value->jlh}}</td>
                   <!--  <td>{{$value->jlh_promo - $value->jlh}}</td> -->
                    <td>
                      <a href="{{url('merchant/detail/promo/'.$value->kode_promo)}}">Lihat Data</a>
                    </td>
                  </tr>
        @endforeach
                </tbody>
