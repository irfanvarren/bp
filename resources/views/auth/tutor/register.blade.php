@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register','activeMenu' =>'' ,'title' => __('Material Dashboard')])
...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-lg-6 col-md-8 col-sm-10 ml-auto mr-auto">
      ...
      <form class="form" method="POST" action="{{route('post-tutor-register')}}">
        @csrf
