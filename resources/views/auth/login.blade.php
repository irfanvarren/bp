@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login','activeMenu' => '', 'title' => __('BP')])
...
<div class="container" style="height: auto;">
   @if(session('message'))
   <div class="alert alert-warning" style="text-align:center" id="alert">
    <h4><strong>{!! session('message') !!}</strong></h4> <br>

    <button type="button" class="btn btn-primary" onclick="document.getElementById('alert').style.display = 'none'" name="button">Ok</button>
  </div>
  @endif  
        ...
        <div class="card card-login mb-3">
          <div class="card-header card-header-primary text-center">
            ...
            <div class="social-line">
              <a href="{{ url('/auth/facebook') }}" onclick="" class="btn btn-just-icon btn-link btn-white">
                <i class="fa fa-facebook-square"></i>
              </a>
              <a href="{{ url('/auth/twitter') }}" onclick="" class="btn btn-just-icon btn-link btn-white">
                <i class="fa fa-twitter"></i>
              </a>
              <a href="{{ url('/auth/google') }}" onclick="" class="btn btn-just-icon btn-link btn-white">
