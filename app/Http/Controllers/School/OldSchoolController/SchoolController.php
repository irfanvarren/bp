...
namespace App\Http\Controllers\School\OldSchoolController;
...
class SchoolController extends Controller
{
    ...
    public function school_intake(SchoolIntake $model,Request $request){
      ...
      return view("sekolah.admin.schools.school_intake",["school_intake" => $school_intake]);
    }
    public function school_program(Request $request){
       ...
       //return view('sekolah.admin.schools.school_program',['school_programs' => $school_programs]);
    }
